...
export function useAddLiquidityCANTO(chainId: number| undefined, details : Details) {
    const routerAddress = getRouterAddress(chainId);
    const RouterInterface = new utils.Interface(routerAbi);
    const contract = new Contract(routerAddress, RouterInterface);
...
export function useRemoveLiquidity(chainId: number| undefined, details : Details) {
    const routerAddress = getRouterAddress(chainId)
    const RouterInterface = new utils.Interface(routerAbi);
    const contract = new Contract(routerAddress, RouterInterface);
...
export function useRemoveLiquidityCANTO(chainId: number| undefined, details : Details) {
    const routerAddress = getRouterAddress(chainId)
    const RouterInterface = new utils.Interface(routerAbi);
    const contract = new Contract(routerAddress, RouterInterface);
