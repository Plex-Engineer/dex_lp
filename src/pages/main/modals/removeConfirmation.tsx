...
export const RemoveLiquidityButton = (props: RemoveConfirmationProps) => {
  ...
  const amountMinOut1 = truncateNumber(
    (Number(props.value1) * (100 - Number(props.slippage))) / 100,
    props.pair.basePairInfo.token1.decimals
  ).toString();
  const amountMinOut2 = truncateNumber(
    (Number(props.value2) * (100 - Number(props.slippage))) / 100,
    ...
    <Container>
      ...
      >
        <RowCell
          ...
          value={truncateByZeros(props.value1.toString()).toString()}
        />
        <RowCell
          type={props.pair.basePairInfo.token2.symbol + " withdrawing: "}
          value={truncateByZeros(props.value2.toString()).toString()}
        />
        <RowCell
          type={"burned: "}
          value={truncateByZeros(LPOut.toString()).toString()}
        />
